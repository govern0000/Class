...
public partial class LibraryGen : TextAdd
{
    ...
    public virtual LibraryGenSetOperate CreateSetOperate()
    {
        LibraryGenSetOperate a;
        a = new LibraryGenSetOperate();
        a.Gen = this;
        a.Init();
        return a;
    }
    ...
    public virtual LibraryGenSetOperate SetOperate { get; set; }
