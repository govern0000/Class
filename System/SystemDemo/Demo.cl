class Demo : Add
{
    ...
    maide private Bool ExecuteStorage()
    {
        ...
        var String dataPath;
        dataPath : "Alan-SystemDemo-96207.08.47/Data";
    ...
    maide private Bool ExecuteStorageStream()
    {
        ...
        storage.Path : "Alan-SystemDemo-96207.08.47/Data/StorageStream.txt";
        storage.Mode : mode;
    ...
    maide private Bool ExecuteNetworkProgram()
    {
        ...
        program : new Program;
        program.Init();
        program.Name : "../Library/Alan-SystemDemoNetwork-0.00.00.exe";
        program.Argue : list;
